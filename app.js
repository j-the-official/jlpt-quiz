...
const TIPS={
  ...
  mondai4:{title:'問題4 單字用法 — 解題技巧',tips:[
    {heading:'不能只背中文意思',content:'這題的關鍵在於「搭配詞」和「使用情境」。例如「おびただしい」主要形容數量、程度非常多（且多用於血、傷亡、蟲子等偏負面的事物），不能拿來形容性格。'},
  ...
  mondai5:{title:'問題5 句子文法 — 解題技巧',tips:[
    {heading:'記住接續規則',content:'每個 N1 句型都有固定的接續方式。例如「〜てからというもの」接動詞て形，「をもってしても」接名詞，「からには」接常體（辞書形・た形皆可）。先看空格前面是什麼形式，就能排除不符合接續的選項。'},
  ...
  mondai6:{title:'問題6 排列組合 — 解題技巧',tips:[
    {heading:'先找「必定相連」的組合',content:'四個選項中，一定有兩個必須相鄰的。例如「〜たとたん」的「とたん」前面一定是動詞た形；「を」的後面遲早要接動詞。先把這些鎖定。'},
